...
The god-object algorithm is based on the God-object paper \cite{zilles95constraintbased}
by .... It uses a point proxy .
- Point proxy
- User defined surfaces

\subsection{Ruspini algorithm}
The ruspini renderer is based on the algorithm presented by Ruspini \cite{ruspini}. It uses a sphere proxy.
- Sphere proxy
- User defined surfaces
