...
\item HapticMaster from Moog/FCS (implemented in the HapticMasterDevice class ). 
\end{itemize}
...
available for all haptics devices.  The functions available can be divided into two classes:
...
The calibration functions lets the user manipulate the coordinate system the values of the haptics device is reported in.
