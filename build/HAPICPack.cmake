    ...
    IF( NOT DEFINED H3DAPI_CPACK_EXTERNAL_ROOT )
      IF( NOT DEFINED HAPI_CPACK_EXTERNAL_ROOT )
        IF( $ENV{H3D_EXTERNAL_ROOT} STREQUAL "" )
          SET( HAPI_CPACK_EXTERNAL_ROOT "" CACHE PATH "Set to the External directory used with HAPI, needed to pack properly. If not set FIND_modules will be used instead." )
        ELSE( $ENV{H3D_EXTERNAL_ROOT} STREQUAL "" )
          SET( HAPI_CPACK_EXTERNAL_ROOT "$ENV{H3D_EXTERNAL_ROOT}" CACHE PATH "Set to the External directory used with HAPI, needed to pack properly. If not set FIND_modules will be used instead." )
