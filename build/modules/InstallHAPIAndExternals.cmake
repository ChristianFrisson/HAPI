      ...
      foreach( feature_to_look_for ${externals_to_look_for} )
        ...
        ELSEIF( ADD_EXTERNAL )
          ...
          ELSEIF( CURRENT_CHECKED_FEATURE STREQUAL "lib" )
            ...
            ELSEIF( TARGET ${feature_to_look_for} OR HAPI_CMAKE_INSTALL_PREFIX )
              set( dirs_to_test "" )
              IF( TARGET ${feature_to_look_for} )
                ...
                set( dirs_to_test ${hapi_release_filename_path} ${dirs_to_test} )
              ENDIF( TARGET ${feature_to_look_for} )
              IF( HAPI_CMAKE_INSTALL_PREFIX )
                set( dirs_to_test ${dirs_to_test}
                                  ${HAPI_CMAKE_INSTALL_PREFIX}/${HAPI_lib}
                                  ${HAPI_CMAKE_INSTALL_PREFIX}/lib )
              ENDIF( HAPI_CMAKE_INSTALL_PREFIX )
              IF( dirs_to_test )
